...
AARectangle::AARectangle(const Vec2D& topLeft, unsigned int width, unsigned height)
{
...
{
	return !(rect.GetBottomRightPoint().GetX() < GetTopLeftPoint().GetX() || 
		rect.GetTopLeftPoint().GetX() > GetBottomRightPoint().GetX() ||
		rect.GetBottomRightPoint().GetY() < GetTopLeftPoint().GetY() ||
